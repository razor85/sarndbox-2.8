...
typedef Geometry::OrthogonalTransformation<Scalar, 3>
  OGTransform; // Type for 3D scaled rigid body transformations
typedef Geometry::ProjectiveTransformation<Scalar, 3>
  PTransform; // Type for 3D projective transformations (4x4 matrices)
