...
class GlobalWaterTool : public Vrui::Tool,
                        public Vrui::Application::Tool<Sandbox> {
  friend class Vrui::GenericToolFactory<GlobalWaterTool>;

  /* Elements: */
private:
  static GlobalWaterToolFactory
    *factory;            // Pointer to the factory object for this class
  float waterAmounts[2]; // Water amount added to the global water renderer when
                         // either tool button was pressed

  /* Constructors and destructors: */
public:
  static GlobalWaterToolFactory *initClass(Vrui::ToolManager &toolManager);
  GlobalWaterTool(const Vrui::ToolFactory *factory,
